...
import 'cardper_model.dart';
export 'cardper_model.dart';

class CardperWidget extends StatefulWidget {
  const CardperWidget({super.key});

  @override
  _CardperWidgetState createState() => _CardperWidgetState();
}

class _CardperWidgetState extends State<CardperWidget>
    with TickerProviderStateMixin {
  late CardperModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CardperModel());
